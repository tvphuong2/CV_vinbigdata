...
class Team:
    ...
    # Hard-code dưới dạng Base64 (kẻ tấn công có thể decode ngược lại)
    encoded_pw = "VmluUGVhcmxATXNlY3JldDIwMjUh"  
    self._password = base64.b64decode(encoded_pw).decode('utf-8')
    ...
    def login(self):
        payload = {"user": self.username, "pass": self._password}
        try:
